...
export const metadata: Metadata = {
  title: 'Wordle Helper',
  description: 'Use the Wordle Helper tool from UnscrambleHQ to find words, anagrams, scores, and useful word game answers fast.',
  alternates: { canonical: '/wordle-helper' }
}
      ...
      <main>
        <section className="bg-soft py-16">
          <div className="container-page text-center">
            <h1 className="text-5xl font-black tracking-tight text-ink">Wordle Helper</h1>
