...
export const metadata: Metadata = {
  ...
  description: 'Use the Anagram Solver tool from UnscrambleHQ to find words, anagrams, scores, and useful word game answers fast.',
  alternates: { canonical: '/anagram-solver' }
}
      ...
      <main>
        <section className="bg-soft py-16">
          <div className="container-page text-center">
            <h1 className="text-5xl font-black tracking-tight text-ink">Anagram Solver</h1>
