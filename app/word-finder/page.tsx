...
export const metadata: Metadata = {
  title: 'Word Finder',
  description: 'Use the Word Finder tool from UnscrambleHQ to find words, anagrams, scores, and useful word game answers fast.',
  alternates: { canonical: '/word-finder' }
}
      ...
      <main>
        <section className="bg-soft py-16">
          <div className="container-page text-center">
            <h1 className="text-5xl font-black tracking-tight text-ink">Word Finder</h1>
